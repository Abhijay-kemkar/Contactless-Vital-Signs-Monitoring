...
(cl:defmethod cl:initialize-instance :after ((m <RGB>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'RGB)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name rppg-msg:<RGB> is deprecated: use rppg-msg:RGB instead.")))

(cl:ensure-generic-function 'm_rgb-val :lambda-list '(m))
(cl:defmethod m_rgb-val ((m <RGB>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader rppg-msg:m_rgb-val is deprecated.  Use rppg-msg:m_rgb instead.")
  (m_rgb m))
